...
from _setup_support import (build_or_install_bokehjs, clean, develop,
...
# state our install requirements here
# TODO (bev) single source of truth? Should this come from meta.yaml?
REQUIRES = [
    'six>=1.5.2',
    'requests>=1.2.3',
    'PyYAML>=3.10',
...
# handle the compatibility difference for futures package for python 2
if sys.version_info[:2] == (2, 7):
    REQUIRES.append('futures>=3.0.3')

fixup_old_js_args()

fixup_argv_for_sdist()
